    ...
    >
      <div className="absolute w-full h-full group-hover:grayscale duration-300 transition-all">
        <Image
          ...
          sizes="full"
          fill
          className="object-cover lg:group-hover:scale-125 duration-300 transition-all"
          onLoad={complete}
        />
      </div>
      <div className="relative w-full h-full z-10 flex justify-center items-center">
        <svg
          ...
          className="w-full h-full absolute scale-75 hidden lg:block"
        >
          <path
        ...
        <div className="absolute h-[60%] w-[80%] bg-[#D9D9D9] rounded-xl block lg:hidden" />
  ...
  return (
    <>
      ...
      <section className="scroll-smooth w-screen h-screen relative">
        <div className="pt-[7vh] h-screen w-screen overflow-y-hidden overflow-hidden grid grid-cols-1 lg:grid-cols-4 p-8">
          {projects &&
